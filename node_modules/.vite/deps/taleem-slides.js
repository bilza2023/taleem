...
var TableSlide = {
  ...
  fromJSON(raw) {
    var _a, _b, _c, _d;
    const headers = (_b = (_a = raw.data) == null ? void 0 : _a.find((d) => d.name === "header")) == null ? void 0 : _b.content;
    const rows = (_d = (_c = raw.data) == null ? void 0 : _c.find((d) => d.name === "row")) == null ? void 0 : _d.content;
    if (!headers || !(rows == null ? void 0 : rows.length)) {
...
// node_modules/taleem-slides/src/resolveBackground.js
function resolveBackground({ deckBackground, theme }) {
  if (deckBackground)
