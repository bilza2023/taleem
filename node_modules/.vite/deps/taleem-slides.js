...
var TableSlide = {
  ...
  fromJSON(raw) {
    var _a;
    const rows = (_a = raw.data) == null ? void 0 : _a.filter((d) => d.name === "row").map((d) => d.content);
...
var BarChartSlide = {
  ...
  fromJSON(raw) {
    var _a;
    const bars = (_a = raw.data) == null ? void 0 : _a.filter((d) => d.name === "bar");
...
var DonutChartSlide = {
  ...
  fromJSON(raw) {
    var _a;
    const segments = (_a = raw.data) == null ? void 0 : _a.filter((d) => d.name === "segment");
...
var CornerWordsSlide = {
  ...
  fromJSON(raw) {
    var _a;
    const words = (_a = raw.data) == null ? void 0 : _a.filter((d) => d.name === "word").map((d) => d.content);
...
var ContactSlide = {
  ...
  fromJSON(raw) {
    var _a;
    const items = (_a = raw.data) == null ? void 0 : _a.map((d) => `<div>${d.content}</div>`);
