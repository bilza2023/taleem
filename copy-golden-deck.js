...
export const goldenDeckV1 = {
    ...
    deck: [
      ...
      // 4 twoColumnText
      {
        ...
        data: [
          { name: "left", content: `
            taleem-browser is index-based which create slide presentations. Complete slide is shown one by one fully drawn.
            `, showAt: 15 },
          { name: "right", content: "taleem-player is scalar/time based and run presentation like a video. Content are progressivelly display like in a video", showAt: 17 }
        ]
      },
